...
class ChoicesControllerTest < ActionController::TestCase
  ...
  test "should create choice" do
    assert_difference('Choice.count') do
      post :create, choice: { count: @choice.count, position: @choice.position, question_id: @choice.question_id, text: @choice.text }
    end
  ...
  test "should update choice" do
    put :update, id: @choice, choice: { count: @choice.count, position: @choice.position, question_id: @choice.question_id, text: @choice.text }
    assert_redirected_to choice_path(assigns(:choice))
  end
